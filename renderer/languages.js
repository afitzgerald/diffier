 ...
 *   1. Shiki (renderer/highlighter-entry.mjs, bundled to highlighter.js) —
 ...
 * diff lines). Loaded as a plain script in the renderer and require()d by
 * tests and the shiki bundle build.
 */
...
(function (global) {
  ...
  else global.DiffierLanguages = api;
